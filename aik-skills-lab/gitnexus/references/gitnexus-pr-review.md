...
description: Review pull requests, assess PR blast radius, check test coverage, evaluate merge safety. Use when the user asks to "Review this PR", "What does PR #42 change?", "Is this PR safe to merge?", or evaluates PRs.
---
